...
from train_fixed_sequence_classifier import FixedSequenceClassifier, resample_features


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate a fixed-length sequence classifier.")
...
def main() -> None:
    ...
    with torch.no_grad():
        for row in rows:
            ...
            features = resample_features(features, sequence_length)
